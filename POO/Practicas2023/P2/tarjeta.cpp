/*
tarjeta.cpp By Raúl Arcos Herrera 2023
*/
...
Numero::Numero(const Cadena& num){
 ...
 char cad[] = "./ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
    size_t it = strcspn ((const char*) num, cad);

    if (it < num.length()) throw Incorrecto(razon::DIGITOS);

    char *pch, *aux = new char[30];
    pch = strpbrk (const_cast<char*> ((const char*) num), "1234567890");
    int i = 0;
